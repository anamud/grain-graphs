...
if (Rstudio_mode) {
    ...
    option_list <- list(make_option(c("-d","--data"), help = "Task profiling data.", metavar="FILE"),
                        ...
                        make_option(c("--removechunkstart"), action="store_true", default=FALSE, help="Remove chunk start nodes without loss of continuity [Experimental]"),
...
if (cl_args$forloop) {
    ...
    if (cl_args$removechunkstart) {
        # This is a experimental feature and maybe removed in future versions
